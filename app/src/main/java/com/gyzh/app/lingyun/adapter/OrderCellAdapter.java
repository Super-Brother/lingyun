 ...
 */
public class OrderCellAdapter extends BaseAdapter {
    Context context;
    JSONArray array;
    ...
    public OrderCellAdapter(Context context, JSONArray array) {
    ...
    public void updateItem(int position, JSONObject object) {
        try {
            this.array.put(position, object);
            this.notifyDataSetChanged();
        } catch (JSONException e) {
            e.printStackTrace();
        }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = inflater.inflate(R.layout.item_order_cell, null);
            ...
            viewHolder.btn_order_kill = (Button) convertView.findViewById(R.id.btn_order_kill);
            viewHolder.btn_order_zhuan = (Button) convertView.findViewById(R.id.btn_order_zhuan);
            viewHolder.btn_order_finish = (Button) convertView.findViewById(R.id.btn_finish);
            convertView.setTag(viewHolder);
        }

        if (onItemViewClickListener != null) {
            viewHolder.btn_order_kill.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            viewHolder.btn_order_finish.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onItemViewClickListener.onItemViewClickListener(v.getId(), position);
                }
        ...
        try {
            ...
            if (state == -2) {
                ...
                viewHolder.btn_order_finish.setText("出发");
            } else if (state == 3) {
                viewHolder.tv_order_state.setText("已出发");
                viewHolder.btn_order_finish.setText("开始");
            } else if (state == 4) {
                viewHolder.tv_order_state.setText("洗车中");
                viewHolder.btn_order_finish.setText("结束");
            } else if (state == 5) {
